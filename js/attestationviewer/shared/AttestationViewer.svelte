<script lang="ts">
	...
	async function ita_attestation(quote: string) {
		const attestation_service = "https://api-dev01-user8.project-amber-smas.com/appraisal/v1/attest";
		const x_api_key = "djE6MTliNjcyYzItMGIzZi00OTg2LWJjYmUtM2RiYzk5YjlhNDRiOkMwT3BwZFgwOXE5WVBDaHlFSzlTMzd3VExsT0VmbnJST3hnWlZNRGM=";
		let retry = 4;
		let response;
		do {
